        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectOfInsurance = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IndividualContracts_InsuranceTypes_InsuranceTypeId",
                        column: x => x.InsuranceTypeId,
                        principalTable: "InsuranceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IndividualContracts_InsuredPersons_InsuredPersonId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IndividualContractId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsuranceEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InsuranceEvents_IndividualContracts_IndividualContractId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Pojištění majetku je souhrnné označení pro několik odvětví neživotního pojištění. Všechna jsou upravena v Hlavě III zákona o pojistné smlouvě „Soukromé pojištění věci a jiného majetku“. Při těchto pojištěních poskytuje pojišťovna pojistnou ochranu majetku v případě, že dojde k jeho zničení, poškození nebo odcizení.", "Pojištění majetku" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndividualContracts_InsuranceTypeId",
                table: "IndividualContracts",
                column: "InsuranceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_IndividualContracts_InsuredPersonId",
                table: "IndividualContracts",
                column: "InsuredPersonId");

            migrationBuilder.CreateIndex(
                name: "IX_InsuranceEvents_IndividualContractId",
